        ...
        <?php
          ...
          try {
            ...
            $event = new Google_Service_Calendar_Event(array(
              ...
              'location' => 'Malaysia',
              'description' => 'The leave application you have applied recently has been '.$action,
              'start' => array(
                // 'date' => '2022-06-27',
                // 'dateTime' => '2022-06-27T09:30:00+08:00',
                'dateTime' => $startDate.'T09:30:00+08:00',
                'timeZone' => 'Asia/Kuala_Lumpur',
              ),
              'end' => array(
                // 'date' => '2022-06-29',
                // 'dateTime' => '2022-06-29T12:30:00+08:00',
                'dateTime' => $endDate.'T12:30:00+08:00',
                'timeZone' => 'Asia/Kuala_Lumpur',
              ),
              'recurrence' => array(
